...
\ Extras
c-function glm-vec3-mulv            glm_vec3_mulv            a a a -- void
c-function glm-vec3-broadcast       glm_vec3_broadcast       r a -- void
c-function glm-vec3-eq              glm_vec3_eq              a r -- n
c-function glm-vec3-eq-eps          glm_vec3_eq_eps          a r -- n
c-function glm-vec3-eq-all          glm_vec3_eq_all          a -- n
c-function glm-vec3-eqv             glm_vec3_eqv             a a -- n
c-function glm-vec3-eqv-eps         glm_vec3_eqv_eps         a a -- n
c-function glm-vec3-max             glm_vec3_max             a -- r
c-function glm-vec3-min             glm_vec3_min             a -- r
c-function glm-vec3-isnan           glm_vec3_isnan           a -- n
c-function glm-vec3-isinf           glm_vec3_isinf           a -- n
c-function glm-vec3-isvalid         glm_vec3_isvalid         a -- n
c-function glm-vec3-sign            glm_vec3_sign            a a -- void
c-function glm-vec3-sqrt            glm_vec3_sqrt            a a -- void
